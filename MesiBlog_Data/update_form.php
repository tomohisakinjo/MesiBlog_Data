...
<body>
    ...
    <form action="blog_update.php" method="POST">
        ...
        <select name="category">
            <option value="1" <?php if($category == 1) echo "selected"?>>南部</option>
            <option value="2" <?php if($category == 2) echo "selected"?>>中部</option>
            <option value="3" <?php if($category == 3) echo "selected"?>>北部</option>
        </select>
        <br>
